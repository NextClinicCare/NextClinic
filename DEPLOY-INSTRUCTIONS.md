# NextClinic — How to deploy to your Vercel + connect your domain

You have 7 files to create in GitHub. For each one:
1. Go to your GitHub repo (github.com/NextClinicCare/nextclinic)
2. Click "Add file" → "Create new file"
3. Type the exact file name
4. Copy-paste the code
5. Click "Commit changes"

After all 7 files are created, go to Vercel → Import the repo → Deploy.
...
<html lang="en">
  <head>
    ...
    <title>NextClinic — Turn missed enquiries into booked appointments</title>
    <meta name="description" content="NextClinic helps aesthetic, cosmetic dentistry and skin clinics respond to every enquiry instantly and follow up automatically until patients book." />
  </head>
  <body>
    <div id="root"></div>
...
## FILE 4: public/favicon.svg

```svg
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40" fill="none">
  <rect width="40" height="40" rx="9" fill="#1b2440"/>
  <text x="20" y="28" text-anchor="middle" font-family="Inter, sans-serif" font-size="22" font-weight="700" fill="#f6f6f4">N</text>
</svg>
```
...
@theme {
  --color-navy: #1b2440;
  --color-navy-light: #2a3559;
  --color-navy-soft: #3a466b;
  --color-offwhite: #f6f6f4;
  --color-offwhite-2: #efeee9;
...
const LOGO_URL = 'https://i.postimg.cc/WpDGrkn6/IMG-3743.jpg'
...
## AFTER ALL 7 FILES ARE IN GITHUB:

1. Go to **Vercel** → **Add New → Project**
2. Click **Import** next to your `nextclinic` repo
3. Click **Deploy** — done in 30 seconds
4. Go to **Settings → Domains** → add `nextclinic.care`
5. Go to **Namecheap → Advanced DNS** → add:
